 ...
 * @property {string} distribution_key
 * @property {string} distribution_value
 */

/**
 * @typedef {Object} AudienceData
 * @property {string} description
 * @property {Distribution[]} distribution_list
...
/**
 * @typedef {Object} AudienceResponse
 * @property {Object} base_resp
 * @property {number} base_resp.status_code
 * @property {string} base_resp.status_message
 * @property {AudienceData[]} distributions
