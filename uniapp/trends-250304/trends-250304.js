...
CustomComponent({
    ...
    data: {
        ...
        cards: [
            ...
            },
            {
                ...
                transform: 'translateY(140rpx) scale(1)',
                title: '次抛服务',
            ...
            // last
            {
                ...
                transform: 'translateY(280rpx) scale(1)',
                title: '全民经济',
                // info: 'trends_card_info_2',
                index: 4
            }
    ...
    methods: {
        ...
        handleReset() {
            this.setData({
                resetAnimating: true,
                backBtnAnimClass: "fade-out",
                showAnimClass: "slide-out-down",
            });

            setTimeout(() => {
                const originalTransforms = [
                    'translateY(0) scale(0.95)',
                    'translateY(140rpx) scale(1)',
                    'translateY(280rpx) scale(1)'
                ];
        ...
        // 动态添加样式
        handleAddStyle(e){
            console.log("handleAddStyle => ", e);
            this.setData({
                clickSelect: !this.data.clickSelect
            })
        }
    }
})
