<template>
  <div class="pallet-deliver-render">
    ...
    <!--        <span class="label">-->
    <!--          仅做展示的Label-->
    <!--&lt;!&ndash;          {{ target.pricing.label }}&ndash;&gt;-->
    <!--        </span>-->
    <!--      <span class="value">-->
    <!--        仅做展示的Value-->
    <!--&lt;!&ndash;          {{ target.pricing.price }}&ndash;&gt;-->
    <!--        </span>-->
    <!--    </div>-->
    <!--第一列-->
    <div class="item a-zryy">
      <span class="label">责任运营</span>
      <span class="value">
        <MemberRender :photo="false" :id="deliveryForm.responsibleOperation"/>
      </span>
    </div>
    ...
    <div class="item a-gg">
      ...
      <div class="value" :class="deliveryClass.productStandard">
        <TextInputPoptip :disabled="readOnly" v-model="deliveryForm.productStandard" />
      </div>
    </div>
    ...
    <div class="item a-zp">
      ...
      <div class="value" :class="deliveryClass.gift">
        <TextInputPoptip :disabled="readOnly" v-model="deliveryForm.gift" />
      </div>
    </div>
    ...
    <div class="item">
      ...
      <div class="value" :class="deliveryClass.productLink">
        <TextInputPoptip :disabled="readOnly" v-model="deliveryForm.productLink" />
      </div>
    </div>
    ...
    <div class="item">
      ...
      <div class="value" :class="deliveryClass.commissionLink">
        <TextInputPoptip :disabled="readOnly" v-model="deliveryForm.commissionLink" />
      </div>
    </div>
    ...
    <div class="item">
      ...
      <div class="value" :class="deliveryClass.mainSellingPoint">
        <TextInputPoptip :disabled="readOnly" v-model="deliveryForm.mainSellingPoint" />
      </div>
    </div>
    ...
    <div class="item">
      ...
      <div class="value" :class="deliveryClass.assignStock">
        <TextInputPoptip :disabled="readOnly" v-model="deliveryForm.assignStock" />
      </div>
    </div>
    ...
    <div class="item a-tydh">
      ...
      <div class="value" :class="deliveryClass.returnCode">
        <TextInputPoptip :disabled="readOnly" v-model="deliveryForm.returnCode" />
      </div>
    </div>
    <div class="item a-tyhm">
      <span class="label">退样手机号码</span>
      <div class="value" :class="deliveryClass. returnSfPhone">
        <TextInputPoptip :disabled="readOnly" v-model="deliveryForm. returnSfPhone" />
      </div>
    </div>
    <div class="item a-tydz">
      <span class="label">退样地址</span>
      <div class="value" :class="deliveryClass.returnAddress">
        <TextInputPoptip :disabled="readOnly" v-model="deliveryForm.returnAddress" />
      </div>
    </div>
    ...
    <div class="item a-tymx">
      ...
      <div class="value" :class="deliveryClass.returnDetails">
        <TextInputPoptip :disabled="readOnly" v-model="deliveryForm.returnDetails" />
      </div>
    </div>
...
export default {
  ...
  created() {
    console.log("PalletDeliveryRender ===> ", this.target)
  },
  watch: {
    target: {
      deep: true,
  ...
  methods: {
    ...
    update(){
      console.log("updateDelivery ===> ", this.deliveryForm)
      this.$emit("updateDelivery", this.deliveryForm);
    },
    getDeliveryFormClass() {
      let delivery = this.target; // 结构出货盘信息
      if(delivery){
        let {
